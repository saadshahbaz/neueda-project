...
public class BusinessRestController {
     ...
     * @throws IllegalArgumentException
     */
    @PostMapping(value = { "/businessHour/{id}/{dayOfWeek}/{startTime}/{endTime}/{businessName}", "/businessHour/{id}/{dayOfWeek}/{startTime}/{endTime}/{businessName}/" })
    public BusinessHourDto createBusinessHour(@PathVariable("id") int id, @PathVariable("dayOfWeek") DayOfWeek dayOfWeek, @PathVariable("startTime") Time startTime, @PathVariable("endTime") Time endTime, @PathVariable("businessName") String businessName ) throws IllegalArgumentException {

        Business business = businessRepo.findBusinessByName(businessName);
        BusinessHour businessHour = businessService.createBusinessHour(id,dayOfWeek,startTime,endTime,business);
